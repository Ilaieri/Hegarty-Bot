...
class MyClient(discord.Client):
    ...
    async def on_ready(self):
        ...
        await self.change_presence(activity=discord.Game(name="Hegarty Maths"))
    ...
    async def on_message(self, message):
        ...
        if data.lower().startswith(self.COMMAND_EXEC):
            ...
            await message.channel.send(
                "Hello! <3 I am Mr Hegarty and I'm soooo goood at math.\nCall me with= to solve basic equations:=1+1\nCall me with graph to solve equations such as: graph x + 1."
            )
...
if __name__ == "__main__":
    ...
    client.run("ODY5OTk5MTg1OTM4NzQ3NDEz.YQGX4Q.-lPeRAXIRWoJxNW1u0s-HB5BdV8")
